...
async def test_create_user(db_conn: AsyncConnection) -> None:
    """create_user returns a dict with id, discord_id, and created_at."""
...
async def test_create_character(db_conn: AsyncConnection) -> None:
    """create_character returns a dict with id, name, and reference_audio_path."""
...
async def _create_test_user(db_conn: AsyncConnection, discord_id: str) -> dict:
...
async def test_create_tts_request(db_conn: AsyncConnection) -> None:
    """create_tts_request returns a dict with pending status."""
